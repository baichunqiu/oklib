...
public class SharedPreferUtil {
    ...
    public final static String BASE_PATH = ROOT + "kit";
    public final static String SP_DEFAULT = "com_kit_common";
    /**
    ...
    public static int get(String key, int defaultValue) {
       return get(SP_DEFAULT,key,defaultValue);
    }
    ...
    public static boolean getBoolean(String key) {
        return get(SP_DEFAULT, key, false);
    }
    /**
     * 移除key对应的项
     *
